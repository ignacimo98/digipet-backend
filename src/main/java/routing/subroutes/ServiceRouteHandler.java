...
public class ServiceRouteHandler extends GenericRouteHandler {
    ...
    public void init() {
        path("/services", () -> {
            ...
            post("/price", map((req, res) -> ServiceHandler.getServicePrice(model, req.body())));
            ...
            get("/:id/detailed", map((req, res) -> ServiceHandler.getServiceDetailed(model, Integer.parseInt(req.params(":id")))));
